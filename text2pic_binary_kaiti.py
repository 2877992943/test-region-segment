...
def loaddata(datapath):
    ...
    for i in range(dic.__len__()):
        dic_d[i]=dic[i]
    return dic_d  #dic_d {k:v}  k-0,1,2...  v-char
    ###########

def single_word2pic(word,i):
    ####input 0,1,2... char ->output array of pic
    global pic_arr
    pygame.init()
    ...
    pygame.image.save(ftext, "e:\\charactor_2\\"+str(i)+".jpg") #d:\t.jpg  not work
    pic_list.append(np.array(Image.open("e:\\charactor_2\\"+str(i)+".jpg").convert('L'))[:32,:32])
        
def save_feats(featlist,name):#[w_floor1,b1,w2,b2]
    featpath="e:\\charactor_2\\"+str(name)
...
if __name__=="__main__":
    ...
    ###############
    save_feats([pic_arr],'pic_arr_kaiti')

    '''
    #####load pickle
    featpath="e:\\charactor_1\\pic_kaiti"
